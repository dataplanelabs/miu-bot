...
class AgentDefaults(BaseModel):
    ...
    workspace: str = "~/.miubot/workspace"
...
class ClaudeCodeConfig(BaseModel):
    """Claude Code SDK tool configuration."""
    enabled: bool = False
    max_turns: int = 25
    timeout: int = 600           # 10 min (coding tasks are long)
    permission_mode: str = "bypassPermissions"
    max_output_chars: int = 15000
    working_dir: str = ""        # empty = use workspace
...
class Config(BaseSettings):
    ...
    def get_api_base(self, model: str | None = None) -> str | None:
        ...
        from miubot.providers.registry import find_by_name
