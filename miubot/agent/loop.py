...
from miubot.providers.base import LLMProvider
from miubot.agent.context import ContextBuilder
from miubot.agent.tools.registry import ToolRegistry
from miubot.agent.tools.filesystem import ReadFileTool, WriteFileTool, EditFileTool, ListDirTool
from miubot.agent.tools.shell import ExecTool
from miubot.agent.tools.web import WebSearchTool, WebFetchTool
from miubot.agent.tools.message import MessageTool
from miubot.agent.tools.spawn import SpawnTool
from miubot.agent.tools.cron import CronTool
from miubot.agent.memory import MemoryStore
from miubot.agent.subagent import SubagentManager
from miubot.session.manager import Session, SessionManager
...
class AgentLoop:
    ...
    def __init__(
        ...
        from miubot.config.schema import ExecToolConfig, ClaudeCodeConfig
    ...
    def _register_default_tools(self) -> None:
        ...
        if self.claude_code_config.enabled:
            from miubot.agent.tools.claude_code import ClaudeCodeTool
    ...
    async def _connect_mcp(self) -> None:
        ...
        from miubot.agent.tools.mcp import connect_mcp_servers
