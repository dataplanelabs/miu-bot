...
from miubot.config.schema import DingTalkConfig
...
class MiubotDingTalkHandler(CallbackHandler):
    """
    Standard DingTalk Stream SDK Callback Handler.
    Parses incoming messages and forwards them to the Miubot channel.
    """
    ...
    async def process(self, message: CallbackMessage):
        ...
        try:
            ...
            # Forward to Miubot via _on_message (non-blocking).
...
class DingTalkChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            handler = MiubotDingTalkHandler(self)
    ...
    async def _on_message(self, content: str, sender_id: str, sender_name: str) -> None:
        """Handle incoming message (called by MiubotDingTalkHandler).
